...
set MAIN_MODULE=com.torutk.gadget.analogclock
set MAIN_CLASS=%MAIN_MODULE%.AnalogClockApp
set LAUNCHER=analogclock
set TARGET_BASE=AnalogClock
set ENABLE_JLINK=0
set ENABLE_WIX=0
...
jlink --module-path %JAVAFX_JMOD_PATH%;build\modules ^
